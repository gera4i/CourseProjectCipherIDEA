...
public class FileCipher extends Task<Void> {
    ...
    public StringProperty status; // To print messages in status box
    ...
    public static String toPrettyBin(int n, int size) {
